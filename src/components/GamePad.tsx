        ...
        <>
            <div className="basis-1/2 container flex flex-col mx-auto gap-y-4">
                ...
                <div className="flex gap-x-4">
                    ...
                    <Badge className={l3 ? "bg-green-800  text-lg" : "bg-slate-800  text-lg text-lg"}>L3</Badge>
                    <Badge className={r3 ? "bg-green-800  text-lg" : "bg-slate-800  text-lg"}>R3</Badge>
                </div>
                <div className="flex gap-x-4">
                    <Badge className={create ? "bg-green-800  text-lg" : "bg-slate-800  text-lg"}>Create</Badge>
                    <Badge className={options ? "bg-green-800  text-lg" : "bg-slate-800  text-lg"}>Options</Badge>
                    <Badge className={touchpad ? "bg-green-800  text-lg" : "bg-slate-800  text-lg"}>Touchpad</Badge>
                    <Badge className={power ? "bg-green-800  text-lg" : "bg-slate-800  text-lg"}>PS Button</Badge>
                </div>
            </div>
            <ToastContainer />
        </>
